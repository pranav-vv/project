...
<body>
    ...
    <div class="features">
        ...
        <div class="feature">
            ...
            <span class="featureTitle">Great Offers!</span>
            <span class="featureDesc">We present our products with exiting offers.</span>
        </div>
    </div>
    <div class="product" id="product">
        ...
        <form action="payment/TxnTest.php" method="post">
            <div class="payment" id="mypayment" style="height: 300px;">
                <h1 class="payTitle">Personal Information</h1>
                <label>Name and Surname</label>
                <input type="text" placeholder="John Doe" class="payInput" name="name" required>
                <label>Phone Number</label>
                <input type="text" placeholder="+1 234 5678" class="payInput" name="phone" required>
                <label>Address</label>
                <input type="text" placeholder="Elton St 21 22-145" class="payInput" name="address" required>
                <input type="text" id="mytitle"  name="title" value="Airforce" hidden>
                <input type="text" id="myprice" name="price" value="119" hidden >
                <input type="text" id="mysize" name="size" value="42" hidden>
                <input type="text" id="mycolor" name="color" value="black" hidden>
                <input type="submit" class="payButton" value="Checkout!">
    ...
    <footer>
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu">
                <span class="copyright">&#169 Pranav and Divyansh. All rights reserved. 2022.</span>
            </div>
        </div>
    </footer>
